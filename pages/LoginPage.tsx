      ...
      <div className="grid md:grid-cols-2 gap-0 bg-off-white rounded-xl shadow-2xl overflow-hidden">
        ...
        <div className="p-8 md:p-12 flex flex-col justify-center">
          ...
          <form className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-orange-primary text-white py-3 rounded-lg font-semibold text-lg hover:bg-orange-hover transition-all duration-300 transform hover:scale-105 shadow-md"
            >
              Entrar
            </button>
          </form>
