...
export const SoapIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6 17a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M19 16V6a2 2 0 00-2-2H9a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2z" />
  </svg>
);
...
export const DataIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M4 7v10m16-10v10M4 11h16M4 17h16" />
  </svg>
);
...
export const ShieldIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 20.944L12 22l9-1.056A12.02 12.02 0 0021 8.944c0-1.063-.162-2.1-.468-3.042z" />
  </svg>
);
...
export const DevicesIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2zM5 7h2m-2 4h2m-2 4h2" />
  </svg>
);
...
export const GymIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
     <path strokeLinecap="round" strokeLinejoin="round" d="M6 6L4 8m14-2l2 2m-8.5 2L10 13m4 0l-1.5-1.5M6 17h12" />
  </svg>
);
...
export const Easy5SIcon: React.FC<IconProps> = ({ className }) => (
    <span className={[className, 'flex', 'gap-2'].filter(Boolean).join(' ')}>
      <SoapIcon />
      <GearIcon />
    </span>
);
  
export const EasyStock360Icon: React.FC<IconProps> = ({ className }) => (
    <span className={[className, 'flex', 'gap-2'].filter(Boolean).join(' ')}>
      <BoxIcon />
      <TrendUpIcon />
    </span>
...
export const EasyRPIcon: React.FC<IconProps> = ({ className }) => (
    <span className={[className, 'flex', 'gap-2'].filter(Boolean).join(' ')}>
      <ChartIcon />
      <FactoryIcon />
    </span>
