...
// FIX: Changed LockIcon to LockClosedIcon as LockIcon is not an exported member of ../../components/icons
import { LockClosedIcon, CloudIcon, DataIcon, TrainingIcon } from '../../components/icons';
