  ...
  return (
    <section id="cta" className="bg-navy relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20 text-center relative z-10">
        ...
        <div className="mt-8">
          <Link href="/demo" className="inline-block bg-orange-primary text-off-white px-10 py-4 rounded-lg text-xl font-bold hover:bg-orange-hover transition-all duration-300 transform hover:scale-105 shadow-2xl">
